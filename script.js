...
let lastbBack = document.getElementById("bACK");
...
dark.addEventListener("click", () => {
  ...
  $(".dark").hide();
  $(".light").fadeIn();
  $(".after-gif").css("color", "white");
  $(lastbBack).css("background", "#f37631");
  ...
  document.getElementById("logo-arabic-last").src =
    "imgs/296086906_5325494487537129_184201910671316763_n.png";
...
light.addEventListener("click", () => {
  ...
  document.getElementById("logo-arabic-last").src = "imgs/Capture.JPG";
  stop();
});
